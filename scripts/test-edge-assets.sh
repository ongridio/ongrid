...
deps_tag=edge-deps-layout2-obi1-o2-n3-pr4-my5-pg6-r7-m8
next_deps_tag=edge-deps-layout2-obi1-o12-n13-pr14-my15-pg16-r17-m18
...
OBI_VERSION=1 OTELCOL_VERSION=2 NODE_EXPORTER_VERSION=3 \
...
EDGE_BIN_ROOT="$bin_root" \
OBI_VERSION=1 OTELCOL_VERSION=12 NODE_EXPORTER_VERSION=13 \
