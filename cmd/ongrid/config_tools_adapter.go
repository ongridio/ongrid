...
func (a *chatConfigAdapter) DraftAlertRuleConfig(ctx context.Context, caller aiopstools.ConfigCaller, in aiopstools.AlertRuleConfigArgs) (*aiopstools.ConfigDraft, error) {
	...
	rule := normalizeAlertRuleConfigInputForRequest(in.Rule, in.RequestText)
	...
	if res != nil && strings.TrimSpace(res.SkippedReason) != "" {
		reason := strings.TrimSpace(res.SkippedReason)
...
func normalizeTopLevelAlertRuleAliases(in aiopstools.AlertRuleConfigInput) aiopstools.AlertRuleConfigInput {
...
func normalizeNotifyPolicyAliases(in aiopstools.AlertRuleConfigInput) aiopstools.AlertRuleConfigInput {
...
func normalizeAlertRuleConfigInputForRequest(in aiopstools.AlertRuleConfigInput, requestText string) aiopstools.AlertRuleConfigInput {
	in = normalizeMetricSourceScopeForRequest(in, requestText)
	in = normalizeAlertRuleConfigInput(in)
	return applyAlertRuleRequestHints(in, requestText)
}

func normalizeMetricSourceScopeForRequest(in aiopstools.AlertRuleConfigInput, requestText string) aiopstools.AlertRuleConfigInput {
...
func applyAlertRuleRequestHints(in aiopstools.AlertRuleConfigInput, requestText string) aiopstools.AlertRuleConfigInput {
