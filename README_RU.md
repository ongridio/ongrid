...
tar -xf ongrid-v0.15.0-linux-amd64.tar.xz && cd ongrid-v0.15.0-linux-amd64
sudo ./install.sh
```
...
tar -xf ongrid-v0.15.0-linux-arm64.tar.xz && cd ongrid-v0.15.0-linux-arm64
sudo ./install.sh
```
...
```bash
# AMD64
wget https://ongrid.cloud/dl/ongrid-v0.15.0-linux-amd64.tar.xz

# ARM64
wget https://ongrid.cloud/dl/ongrid-v0.15.0-linux-arm64.tar.xz
```
